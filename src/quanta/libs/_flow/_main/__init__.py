...
__all__ = _portfolio_types.to_list() + ['calendar_days', 'trade_days', 'trade_keys', 'finance_keys']
__instance__.update({'calendar_days':calendar_days, 'trade_days': trade_days, 'trade_keys': trade_keys, 'finance_keys': finance_keys})
